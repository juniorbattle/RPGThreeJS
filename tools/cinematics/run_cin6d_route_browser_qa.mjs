...
const OUTPUT_DIR = resolve(process.env.CIN6D_ROUTE_OUTPUT_DIR ?? resolve(process.cwd(), 'tmp/cinematics/cin6d/browser-qa-routes'));
...
async function finishDialogue(page, sequenceId, choiceIndex = 0, trace = undefined) {
  ...
  await dialogue.waitFor({ state: 'visible', timeout: 30_000 });
