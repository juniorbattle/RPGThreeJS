...
async function main(): Promise<void> {
  ...
  const invariants = {
    DIALOGUES_ACCOUNTED: `${dialogues.size}/73`,
    ORIGINAL_STEPS_ACCOUNTED: `${originalSteps}/251`,
  ...
  </style></head><body><main><h1>CIN-6E-A.4R Dialogue Review</h1><p class="summary">STATIC-TABLEAU-FIRST · ${dialogues.size}/73 dialogues · ${originalSteps}/251 steps · ${choiceStates}/28 choice states · ${beforeWords} → ${afterWords} words · zero dialogue on video/HOLD · zero speaker reassignments · zero choice/effect changes</p>${operatorReviewIndex}${screenshotReview}${reviewCards}</main></body></html>`;
