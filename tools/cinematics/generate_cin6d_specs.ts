...
const CONTENT_VARIANTS: Record<string, string[]> = {
  ...
  'lion-witnesses': ['witnesses_on_road', 'witness_road_clash'],
...
const CONDITIONS: Record<string, string[]> = {
  ...
  'lion-witnesses': ['Witness treatment choice may remain social or escalate into the militia clash'],
...
const BEATS: Record<string, string[]> = {
  ...
  'lion-witnesses': ['ARRIVAL', 'ENCOUNTER', 'DIALOGUE', 'DECISION', 'PRE_COMBAT', 'COMBAT', 'POST_COMBAT', 'AFTERMATH', 'DEPARTURE'],
