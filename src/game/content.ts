    ...
    steps: [
      {
        ...
        effects: [],
        choices: [
          { text: 'Présenter les survivants et les preuves.', next: '2', requiresFlag: 'missionSuccess', excludesFlag: 'missionGreed', requiresReputationMin: 50, blockedText: 'Vos actes à Bois-Clair parlent contre vous.', effects: [{ type: 'addReputation', amount: 8 }, { type: 'setFlag', key: 'lionSealHonour', value: true }, { type: 'startCombat', combatId: 'serpent_captain' }] },
      ...
      { id: '2', speaker: 'Chef Alaric', actorId: 'alaric', expression: 'grateful', tag: 'Respect', text: 'Alors le Lion vous reconnaît. Le général Serpent fuit avec un artefact des Ombres. Finissez ce que vous avez commencé.', side: 'right', next: null, effects: [], choices: [] },
    ...
    steps: [
      {
        ...
        expression: 'mystical',
        tag: 'Révélation',
        text: 'Le combat est fini. Mais ce que portait l’ennemi n’était pas une arme ordinaire — c’est une marque des Ombres.',
        side: 'left',
        next: null,
        effects: [],
        choices: [
