  ...
  },
  {
    ...
    steps: [
      ...
      { id: '3lie', speaker: 'Champion du Lion', actorId: 'lion_champion', expression: 'hostile', tag: 'Défi', text: 'Les témoins sont là. Ils se taisent — non par loyauté, mais par peur. La peur n’est pas un témoignage.', side: 'right', next: '4', effects: [], choices: [] },
      {
        ...
        effects: [],
        choices: [
          { text: 'Vous avez honoré le mandat du Lion.', next: '4h', requiresFlag: 'lionMandateHonour', effects: [] },
          { text: 'Vous avez négocié votre mandat.', next: '4n', excludesFlag: 'lionMandateHonour', effects: [] },
        ],
      },
      {
        id: '4h',
        ...
        expression: 'grateful',
        tag: 'Jugement honoré',
        text: 'Le mandat honoré pèse en votre faveur. Votre réputation, couplée à votre serment, parle plus fort que vos mots seuls.',
        side: 'right',
        next: null,
        effects: [],
        choices: [
          { text: 'Le Lion vous reconnaît digne du Sceau.', next: '5', requiresReputationMin: 40, effects: [{ type: 'setFlag', key: 'lionSealAcknowledged', value: true }] },
          { text: 'Le Lion doute, malgré votre mandat.', next: '5', requiresReputationMax: 39, effects: [{ type: 'setFlag', key: 'alaricDoubt', value: true }] },
        ],
      },
      {
        id: '4n',
        ...
        expression: 'stern',
        tag: 'Jugement',
        text: 'L’avance que vous avez réclamée n’a pas été oubliée. Votre réputation doit parler plus fort que votre dette.',
        side: 'right',
        next: null,
        effects: [],
        choices: [
