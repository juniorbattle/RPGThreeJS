...
const rawDialogues = [
  ...
  },
  {
    ...
    steps: [
      ...
      { id: '3', speaker: 'Intendant Maelor', actorId: 'maelor', expression: 'neutral', tag: 'Silence', text: 'La vérité coûte cher. Heureusement, le silence a un prix plus simple.', side: 'left', next: '3a', effects: [], choices: [] },
      { id: '3a', speaker: 'Marian', actorId: 'marian', expression: 'stern', tag: 'Silence contraint', text: 'Simple pour nous, peut-être. Pour eux, ce prix signifie choisir entre leur sécurité immédiate et le droit de raconter ce qu’ils ont vécu.', side: 'left', next: '3b', effects: [], choices: [] },
      { id: '3b', speaker: 'Survivant de Bois-Clair', actorId: 'survivor', expression: 'fearful', tag: 'Voix retenue', text: 'Nous prendrons l’or parce que la route dévore les familles sans provisions. Ne prenez pas notre besoin pour un accord. Le silence voyagera avec vous autrement.', side: 'left', next: null, effects: [], choices: [] },
