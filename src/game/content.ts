...
const rawCombats: RawCombatConfig[] = [
  ...
  { id: 'serpent_duelist_trial', sceneId: 'forest_route', objective: 'Défaites le duelliste Serpent avant qu’il ne coupe la retraite.', encounterLabel: 'Duel sous les pins', encounterRank: 'elite', maxPlayerUnits: 4, rewards: { gold: 150, reputation: 4, materials: { red_gem: 2 } } },
  { id: 'troll_crossing', sceneId: 'forest_route', objective: 'Forcez le passage gardé par le troll des pierres moussues.', encounterLabel: 'Passage du troll', encounterRank: 'elite', maxPlayerUnits: 4, rewards: { gold: 170, reputation: 5, materials: { red_gem: 2 } } },
  { id: 'young_dragon_roost', sceneId: 'lion_sanctum', objective: 'Approchez le nid du jeune dragon et survivez à son courroux.', encounterLabel: 'Nid du jeune dragon', encounterRank: 'elite', maxPlayerUnits: 4, rewards: { gold: 240, reputation: 6, materials: { red_gem: 2 } } },
  { id: 'serpent_captain', sceneId: 'lion_sanctum', objective: 'Traquez le général Serpent et exposez l’artefact des Ombres.', encounterLabel: 'Général Serpent', encounterRank: 'boss', maxPlayerUnits: 4, isBoss: true, rewards: { gold: 220, reputation: 12, materials: { red_gem: 4 } } },
...
const rawDialogues = [
  ...
  },
  {
    ...
    steps: [
      ...
      { id: '2', speaker: 'Chef Alaric', actorId: 'alaric', expression: 'grateful', tag: 'Respect', text: 'Alors le Lion vous reconnaît. Mais le général Serpent fuit avec un artefact des Ombres. Finissez ce que vous avez commencé.', side: 'right', next: null, effects: [], choices: [] },
