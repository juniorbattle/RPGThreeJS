...
export const NARRATIVE_PRESENTATION_DOCTRINE: readonly NarrativePresentationDefinition[] = Object.freeze([
  ...
  { beatId: 'dialogue:pre_witness_road_clash', primaryInteractiveMode: 'STATIC_TABLEAU', mainEvent: false, cinematicRequirement: 'NONE', cinematicTier: 'NONE', cinematicPlacement: 'TBD', combatOutcome: 'NONE', notes: 'Witness Road militia confrontation before conditional combat.' },
  { beatId: 'combat:witness_road_clash', primaryInteractiveMode: 'NONE', mainEvent: false, cinematicRequirement: 'NONE', cinematicTier: 'NONE', cinematicPlacement: 'TBD', combatOutcome: 'CONDITIONAL', combatTrigger: 'witness_road_clash', notes: 'Witness Road clash - triggered only by choosing to silence the witnesses by force.' },
  { beatId: 'dialogue:post_witness_road_clash', primaryInteractiveMode: 'STATIC_TABLEAU', mainEvent: false, cinematicRequirement: 'NONE', cinematicTier: 'NONE', cinematicPlacement: 'TBD', combatOutcome: 'NONE', notes: 'Witness Road aftermath preserves silencedWitnesses as the sole conduct fact.' },
  ...
  { beatId: 'dialogue:rep_event_roadside_intimidation', primaryInteractiveMode: 'STATIC_TABLEAU', mainEvent: false, cinematicRequirement: 'NONE', cinematicTier: 'NONE', cinematicPlacement: 'TBD', combatOutcome: 'CONDITIONAL', combatTrigger: 'serpent_reprisals', notes: 'Reputation event; refusing the Serpent tribute escalates into the existing reprisals combat.' },
