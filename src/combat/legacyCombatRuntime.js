...
// ============================= UNIT DEFINITIONS =============================
const DEFS=[
  {team:'player',kind:'knight', name:'Chevalier',className:'Guerrier',portrait:'/assets/characters/pixel/full/alistair.png',hp:130,str:24,mag:4, end:20,dex:9, cha:10,mov:2, weapons:[{name:'Épée',icon:'⚔️',type:'phys',min:1,max:1,power:10,crit:0.10,acc:0.95}], skills:['w_break_guard','w_charge','w_whirl','w_lion_surge'], gx:0,gz:0},
  {team:'player',kind:'cleric', name:'Clerc',className:'Mage Blanc',portrait:'/assets/characters/pixel/full/marian.png',    hp:90, str:8, mag:20,end:13,dex:11,cha:18,mov:2, weapons:[{name:'Masse',icon:'🔨',type:'phys',min:1,max:1,power:8,crit:0.06,acc:0.92}], skills:['w_salvation','w_purify','w_sanctuary','w_miracle'], gx:0,gz:1},
  {team:'player',kind:'mage',   name:'Mage',className:'Mage Noir',portrait:'/assets/characters/pixel/full/elara.png',     hp:70, str:4, mag:26,end:9, dex:12,cha:10,mov:2, weapons:[{name:'Bâton',icon:'🪄',type:'mag',min:1,max:2,power:8,crit:0.06,acc:0.95}], skills:['n_dark_bolt','n_teleport','n_flame_wave','n_dark_meteor'], gx:1,gz:2},
  {team:'player',kind:'archer', name:'Archère',className:'Archer',portrait:'/assets/characters/pixel/full/kestrel.png',  hp:80, str:18,mag:5, end:11,dex:18,cha:9, mov:3, weapons:[{name:'Arc',icon:'🏹',type:'phys',min:2,max:4,power:9,crit:0.10,acc:0.92}], skills:['a_precise_shot','a_hawk_leap','a_arrow_rain','a_zenith_arrow'], gx:1,gz:3},
  {team:'player',kind:'knight', name:'Paladin',className:'Paladin',portrait:'/assets/characters/pixel/full/lion_champion.png',hp:135,str:17,mag:12,end:16,dex:10,cha:14,mov:2,weapons:[{name:'Lame sainte',icon:'⚔',type:'phys',min:1,max:1,power:10,crit:0.06,acc:0.93}],skills:['p_holy_strike','p_interpose','p_oathwall','p_radiant_judgement'],gx:0,gz:2},
  {team:'player',kind:'darkmage',name:'Chevalier Noir',className:'Chevalier Noir',portrait:'/assets/characters/pixel/full/maelor.png',hp:125,str:19,mag:14,end:14,dex:11,cha:8,mov:2,weapons:[{name:'Lame maudite',icon:'⚔',type:'phys',min:1,max:1,power:11,crit:0.08,acc:0.92}],skills:['d_cursed_blade','d_void_step','d_blood_pact','d_devouring_eclipse'],gx:0,gz:3},
  {team:'player',kind:'mage',   name:'Mage Rouge',className:'Mage Rouge',portrait:'/assets/characters/pixel/full/seraphine.png',hp:95,str:13,mag:20,end:10,dex:13,cha:14,mov:2,weapons:[{name:'Bâton rouge',icon:'✦',type:'mag',min:1,max:2,power:9,crit:0.06,acc:0.95}],skills:['r_arcane_blade','r_rune_step','r_scarlet_circle','r_perfect_duality'],gx:1,gz:0},
  {team:'player',kind:'cleric', name:'Enchanteur',className:'Enchanteur',portrait:'/assets/characters/pixel/full/chroniqueur.png',hp:90,str:6,mag:22,end:10,dex:12,cha:20,mov:2,weapons:[{name:'Sceau',icon:'✦',type:'mag',min:1,max:2,power:7,crit:0.04,acc:0.94}],skills:['e_vigor_rune','e_transpose','e_binding_seal','e_absolute_harmony'],gx:1,gz:1},
  {team:'player',kind:'rogue',  name:'Ninja',className:'Ninja',portrait:'/assets/characters/pixel/full/seal_guardian.png',hp:105,str:16,mag:8,end:10,dex:24,cha:10,mov:3,weapons:[{name:'Dague',icon:'†',type:'phys',min:1,max:1,power:8,crit:0.20,acc:0.95}],skills:['ni_venom_blade','ni_shadow_step','ni_smoke_bomb','ni_silent_assassin'],gx:2,gz:0},
  {team:'player',kind:'archer', name:'Artilleur',className:'Artilleur',portrait:'/assets/characters/pixel/full/fallback_hero.png',hp:110,str:16,mag:6,end:12,dex:18,cha:8,mov:2,weapons:[{name:'Arbalète',icon:'⌁',type:'phys',min:2,max:4,power:10,crit:0.08,acc:0.93}],skills:['ar_calibrated_shot','ar_explosive_retreat','ar_incendiary_grenade','ar_artillery_barrage'],gx:2,gz:1},
  {team:'foe',kind:'brigand', name:'Brigand',className:'Brigand',portrait:'/assets/characters/pixel/full/serpent_raider.png',  hp:90, str:18,mag:4, end:11,dex:14,cha:6, mov:2, weapons:[{name:'Dague',icon:'🗡️',type:'phys',min:1,max:1,power:9,crit:0.18,acc:0.95}], skills:[], ai:'aggressive', gx:6,gz:0},
  {team:'foe',kind:'brigand', name:'Brigand',className:'Brigand',portrait:'/assets/characters/pixel/full/serpent_raider.png',  hp:90, str:18,mag:4, end:11,dex:14,cha:6, mov:2, weapons:[{name:'Dague',icon:'🗡️',type:'phys',min:1,max:1,power:9,crit:0.18,acc:0.95}], skills:[], ai:'aggressive', gx:6,gz:3},
  {team:'foe',kind:'brute',   name:'Brute',className:'Brute',portrait:'/assets/characters/pixel/full/serpent_brute.png',    hp:130,str:22,mag:4, end:16,dex:7, cha:5, mov:2, weapons:[{name:'Massue',icon:'🏏',type:'phys',min:1,max:1,power:13,crit:0.05,acc:0.85}], skills:['enemy_heavy_strike'], ai:'guardian', gx:7,gz:1},
  {team:'foe',kind:'darkmage',name:'Mage Noir',className:'Mage Noir',portrait:'/assets/characters/pixel/full/serpent_oracle.png',hp:70, str:4, mag:22,end:10,dex:12,cha:8, mov:2, weapons:[{name:'Bâton',icon:'🪄',type:'mag',min:1,max:3,power:8,crit:0.05,acc:0.95}], skills:['enemy_dark_bolt','enemy_hex'], ai:'cautious', gx:7,gz:2}
];
...
const BOSS_ESCORTS={
  serpent_captain:[
    {team:'foe',kind:'brigand', name:'Garde Serpent',className:'Garde Serpent',portrait:'/assets/characters/pixel/full/serpent_raider.png',hp:95,str:19,mag:4,end:12,dex:14,cha:6,mov:2,weapons:[{name:'Dague',icon:'†',type:'phys',min:1,max:1,power:9,crit:0.18,acc:0.95}],skills:[],ai:'aggressive',gx:7,gz:0},
    {team:'foe',kind:'brigand', name:'Garde Serpent',className:'Garde Serpent',portrait:'/assets/characters/pixel/full/serpent_raider.png',hp:95,str:19,mag:4,end:12,dex:14,cha:6,mov:2,weapons:[{name:'Dague',icon:'†',type:'phys',min:1,max:1,power:9,crit:0.18,acc:0.95}],skills:[],ai:'aggressive',gx:7,gz:3},
    {team:'foe',kind:'darkmage',name:'Oracle Serpent',className:'Oracle Serpent',portrait:'/assets/characters/pixel/full/serpent_oracle.png',hp:78,str:4,mag:23,end:10,dex:12,cha:8,mov:2,weapons:[{name:'Bâton',icon:'✦',type:'mag',min:1,max:3,power:8,crit:0.05,acc:0.95}],skills:['enemy_dark_bolt','enemy_hex'],ai:'cautious',gx:4,gz:3}
  ],
  lion_chief:[
    {team:'foe',kind:'knight',name:'Champion du Lion',className:'Champion du Lion',portrait:'/assets/characters/pixel/full/alaric.png',hp:120,str:22,mag:4,end:17,dex:9,cha:9,mov:2,weapons:[{name:'Lame',icon:'⚔',type:'phys',min:1,max:1,power:12,crit:0.08,acc:0.92}],skills:['enemy_heavy_strike'],ai:'guardian',gx:7,gz:0},
    {team:'foe',kind:'darkmage',name:'Gardien du Sceau',className:'Gardien du Sceau',portrait:'/assets/characters/pixel/full/shrine_apparition.png',hp:92,str:8,mag:20,end:13,dex:10,cha:16,mov:2,weapons:[{name:'Sceau',icon:'✦',type:'mag',min:1,max:3,power:8,crit:0.04,acc:0.94}],skills:['enemy_hex','boss_guard'],ai:'cautious',gx:7,gz:3}
  ]
};

const VISUAL_UNIT_TEMPLATES={
  serpent_raider:{team:'foe',kind:'brigand', name:'Pillard Serpent',className:'Pillard Serpent',portrait:'/assets/characters/pixel/full/serpent_raider.png',hp:90,str:18,mag:4,end:11,dex:14,cha:6,mov:2,weapons:[{name:'Dague',icon:'†',type:'phys',min:1,max:1,power:9,crit:0.18,acc:0.95}],skills:[],ai:'aggressive'},
  serpent_brute:{team:'foe',kind:'brute',name:'Brute Serpent',className:'Brute Serpent',portrait:'/assets/characters/pixel/full/serpent_brute.png',hp:130,str:22,mag:4,end:16,dex:7,cha:5,mov:2,weapons:[{name:'Massue',icon:'◆',type:'phys',min:1,max:1,power:13,crit:0.05,acc:0.85}],skills:['enemy_heavy_strike'],ai:'guardian'},
  serpent_oracle:{team:'foe',kind:'darkmage',name:'Oracle Serpent',className:'Oracle Serpent',portrait:'/assets/characters/pixel/full/serpent_oracle.png',hp:78,str:4,mag:23,end:10,dex:12,cha:8,mov:2,weapons:[{name:'Bâton',icon:'✦',type:'mag',min:1,max:3,power:8,crit:0.05,acc:0.95}],skills:['enemy_dark_bolt','enemy_hex'],ai:'cautious'},
  ...
  wolf:{team:'foe',kind:'brigand',name:'Loup',className:'Loup',portrait:'/assets/characters/pixel/full/wolf.png',hp:82,str:19,mag:2,end:10,dex:18,cha:4,mov:3,weapons:[{name:'Morsure',icon:'◆',type:'phys',min:1,max:1,power:10,crit:0.12,acc:0.94}],skills:[],ai:'aggressive'},
  venom_serpent:{team:'foe',kind:'brigand',name:'Serpent venimeux',className:'Serpent venimeux',portrait:'/assets/characters/pixel/full/venom_serpent.png',hp:95,str:17,mag:8,end:12,dex:13,cha:4,mov:2,weapons:[{name:'Crochets',icon:'◆',type:'phys',min:1,max:1,power:9,crit:0.1,acc:0.93}],skills:['enemy_venom_strike'],ai:'cautious'},
  forest_spider:{team:'foe',kind:'brigand',name:'Araignee forestiere',className:'Araignee forestiere',portrait:'/assets/characters/pixel/full/forest_spider.png',hp:72,str:16,mag:6,end:9,dex:17,cha:3,mov:3,weapons:[{name:'Mandibules',icon:'◆',type:'phys',min:1,max:1,power:8,crit:0.12,acc:0.93}],skills:['enemy_binding_shot'],ai:'aggressive'},
  forest_badger:{team:'foe',kind:'brigand',name:'Blaireau',className:'Blaireau',portrait:'/assets/characters/pixel/full/forest_badger.png',hp:88,str:18,mag:2,end:12,dex:14,cha:3,mov:2,weapons:[{name:'Griffes',icon:'◆',type:'phys',min:1,max:1,power:10,crit:0.1,acc:0.92}],skills:[],ai:'aggressive'},
  marsh_toad:{team:'foe',kind:'brute',name:'Crapaud toxique',className:'Crapaud toxique',portrait:'/assets/characters/pixel/full/marsh_toad.png',hp:108,str:14,mag:10,end:15,dex:8,cha:3,mov:2,weapons:[{name:'Langue lourde',icon:'◆',type:'phys',min:1,max:2,power:8,crit:0.04,acc:0.88}],skills:['enemy_venom_strike'],ai:'guardian'},
  cave_rat:{team:'foe',kind:'brigand',name:'Rat geant',className:'Rat geant',portrait:'/assets/characters/pixel/full/cave_rat.png',hp:68,str:14,mag:2,end:8,dex:20,cha:2,mov:3,weapons:[{name:'Morsure',icon:'◆',type:'phys',min:1,max:1,power:8,crit:0.16,acc:0.94}],skills:[],ai:'aggressive'},
  wild_boar:{team:'foe',kind:'brute',name:'Sanglier',className:'Sanglier',portrait:'/assets/characters/pixel/full/wild_boar.png',hp:116,str:21,mag:2,end:15,dex:10,cha:3,mov:2,weapons:[{name:'Charge',icon:'◆',type:'phys',min:1,max:1,power:12,crit:0.08,acc:0.9}],skills:['enemy_heavy_strike'],ai:'guardian'},
  goblin:{team:'foe',kind:'brigand',name:'Gobelin',className:'Gobelin',portrait:'/assets/characters/pixel/full/goblin.png',hp:75,str:15,mag:4,end:9,dex:16,cha:5,mov:3,weapons:[{name:'Lance rouillée',icon:'↟',type:'phys',min:1,max:2,power:8,crit:0.08,acc:0.9}],skills:[],ai:'aggressive'},
  skeleton:{team:'foe',kind:'knight',name:'Squelette',className:'Squelette',portrait:'/assets/characters/pixel/full/skeleton.png',hp:105,str:18,mag:4,end:14,dex:8,cha:3,mov:2,weapons:[{name:'Épée rouillée',icon:'⚔',type:'phys',min:1,max:1,power:10,crit:0.05,acc:0.88}],skills:['enemy_heavy_strike'],ai:'guardian'},
  troll:{team:'foe',kind:'brute',name:'Troll',className:'Troll',portrait:'/assets/characters/pixel/full/troll.png',hp:190,str:28,mag:3,end:22,dex:5,cha:4,mov:2,weapons:[{name:'Tronc',icon:'◆',type:'phys',min:1,max:1,power:16,crit:0.04,acc:0.82}],skills:['enemy_heavy_strike'],ai:'guardian'},
  young_wyrm:{team:'foe',kind:'brute',name:'Jeune Wyrm',className:'Jeune Wyrm',portrait:'/assets/characters/pixel/full/young_wyrm.png',hp:160,str:24,mag:14,end:18,dex:10,cha:8,mov:2,weapons:[{name:'Souffle court',icon:'✦',type:'mag',min:1,max:2,power:14,crit:0.06,acc:0.88}],skills:['enemy_dark_bolt'],ai:'cautious'},
  ...
  lion_champion:{team:'foe',kind:'knight',name:'Champion du Lion',className:'Champion du Lion',portrait:'/assets/characters/pixel/full/lion_champion.png',hp:120,str:22,mag:4,end:17,dex:9,cha:9,mov:2,weapons:[{name:'Lame',icon:'⚔',type:'phys',min:1,max:1,power:12,crit:0.08,acc:0.92}],skills:['enemy_heavy_strike'],ai:'guardian'},
  seal_guardian:{team:'foe',kind:'darkmage',name:'Gardien du Sceau',className:'Gardien du Sceau',portrait:'/assets/characters/pixel/full/seal_guardian.png',hp:92,str:8,mag:20,end:13,dex:10,cha:16,mov:2,weapons:[{name:'Sceau',icon:'✦',type:'mag',min:1,max:3,power:8,crit:0.04,acc:0.94}],skills:['enemy_hex','boss_guard'],ai:'cautious'}
};
