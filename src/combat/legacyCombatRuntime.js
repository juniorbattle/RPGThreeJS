...
const DEFS=[
  ...
  {team:'foe',kind:'brigand', name:'Brigand',className:'Brigand',portrait:'/assets/characters/pixel/full/serpent_raider.png',  hp:90, str:14,mag:4, end:11,dex:14,cha:6, mov:2, weapons:[{name:'Dague',icon:'🗡️',type:'phys',min:1,max:1,power:9,crit:0.18,acc:0.95}], skills:[], ai:'aggressive', gx:6,gz:0},
  {team:'foe',kind:'brigand', name:'Brigand',className:'Brigand',portrait:'/assets/characters/pixel/full/serpent_raider.png',  hp:90, str:14,mag:4, end:11,dex:14,cha:6, mov:2, weapons:[{name:'Dague',icon:'🗡️',type:'phys',min:1,max:1,power:9,crit:0.18,acc:0.95}], skills:[], ai:'aggressive', gx:6,gz:3},
  {team:'foe',kind:'brute',   name:'Brute',className:'Brute',portrait:'/assets/characters/pixel/full/serpent_brute.png',    hp:130,str:18,mag:4, end:16,dex:7, cha:5, mov:2, weapons:[{name:'Massue',icon:'🏏',type:'phys',min:1,max:1,power:13,crit:0.05,acc:0.85}], skills:['enemy_heavy_strike'], ai:'guardian', gx:7,gz:1},
  {team:'foe',kind:'darkmage',name:'Mage Noir',className:'Mage Noir',portrait:'/assets/characters/pixel/full/serpent_oracle.png',hp:70, str:4, mag:19,end:10,dex:12,cha:8, mov:2, weapons:[{name:'Bâton',icon:'🪄',type:'mag',min:1,max:3,power:8,crit:0.05,acc:0.95}], skills:['enemy_dark_bolt','enemy_hex'], ai:'cautious', gx:7,gz:2}
];
...
const BOSS_ESCORTS={
  serpent_captain:[
    {team:'foe',kind:'brigand', name:'Garde Serpent',className:'Garde Serpent',portrait:'/assets/characters/pixel/full/serpent_raider.png',hp:95,str:15,mag:4,end:12,dex:14,cha:6,mov:2,weapons:[{name:'Dague',icon:'†',type:'phys',min:1,max:1,power:9,crit:0.18,acc:0.95}],skills:[],ai:'aggressive',gx:7,gz:0},
    {team:'foe',kind:'brigand', name:'Garde Serpent',className:'Garde Serpent',portrait:'/assets/characters/pixel/full/serpent_raider.png',hp:95,str:15,mag:4,end:12,dex:14,cha:6,mov:2,weapons:[{name:'Dague',icon:'†',type:'phys',min:1,max:1,power:9,crit:0.18,acc:0.95}],skills:[],ai:'aggressive',gx:7,gz:3},
    {team:'foe',kind:'darkmage',name:'Oracle Serpent',className:'Oracle Serpent',portrait:'/assets/characters/pixel/full/serpent_oracle.png',hp:78,str:4,mag:19,end:10,dex:12,cha:8,mov:2,weapons:[{name:'Bâton',icon:'✦',type:'mag',min:1,max:3,power:8,crit:0.05,acc:0.95}],skills:['enemy_dark_bolt','enemy_hex'],ai:'cautious',gx:4,gz:3}
  ],
  lion_chief:[
    {team:'foe',kind:'knight',name:'Champion du Lion',className:'Champion du Lion',portrait:'/assets/characters/pixel/full/alaric.png',hp:120,str:20,mag:4,end:17,dex:9,cha:9,mov:2,weapons:[{name:'Lame',icon:'⚔',type:'phys',min:1,max:1,power:12,crit:0.08,acc:0.92}],skills:['enemy_heavy_strike'],ai:'guardian',gx:7,gz:0},
...
const VISUAL_UNIT_TEMPLATES={
  ...
  cave_rat:{team:'foe',kind:'brigand',name:'Rat geant',className:'Rat geant',portrait:'/assets/characters/pixel/full/cave_rat.png',hp:68,str:11,mag:2,end:8,dex:20,cha:2,mov:3,weapons:[{name:'Morsure',icon:'◆',type:'phys',min:1,max:1,power:8,crit:0.16,acc:0.94}],skills:[],ai:'aggressive'},
