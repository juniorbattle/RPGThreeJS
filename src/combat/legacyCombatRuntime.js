...
const EXTERNAL_SPRITE_HEIGHTS={
  ...
  '/assets/characters/pixel/full/aldric.png':2.08,
  '/assets/characters/pixel/full/talon.png':2.05,
...
const DEFS=[
  ...
  {team:'player',kind:'darkmage',name:'Morvan',className:'Chevalier Noir',portrait:'/assets/characters/pixel/full/morvan.png',hp:130,str:18,mag:15,end:14,dex:11,cha:8,mov:2,weapons:[{name:'Lame maudite',icon:'⚔',type:'phys',min:1,max:1,power:11,crit:0.08,acc:0.92}],skills:['d_cursed_blade','d_void_step','d_blood_pact','d_devouring_eclipse'],gx:0,gz:3},
  {team:'player',kind:'mage',   name:'Lyra',className:'Mage Rouge',portrait:'/assets/characters/pixel/full/lyra.png',hp:90,str:12,mag:21,end:9, dex:13,cha:14,mov:2,weapons:[{name:'Bâton rouge',icon:'✦',type:'mag',min:1,max:2,power:9,crit:0.06,acc:0.95}],skills:['r_arcane_blade','r_rune_step','r_scarlet_circle','r_perfect_duality'],gx:1,gz:0},
  {team:'player',kind:'cleric', name:'Eldwin',className:'Enchanteur',portrait:'/assets/characters/pixel/full/eldwin.png',hp:85,str:5,mag:23,end:9, dex:12,cha:20,mov:2,weapons:[{name:'Sceau',icon:'✦',type:'phys',min:1,max:1,power:7,crit:0.04,acc:0.94}],skills:['e_vigor_rune','e_transpose','e_binding_seal','e_absolute_harmony'],gx:1,gz:1},
  {team:'player',kind:'rogue',  name:'Talon',className:'Ninja',portrait:'/assets/characters/pixel/full/talon.png',hp:100,str:15,mag:10,end:10,dex:26,cha:10,mov:3,weapons:[{name:'Dague',icon:'†',type:'phys',min:1,max:1,power:8,crit:0.20,acc:0.95}],skills:['ni_venom_blade','ni_shadow_step','ni_smoke_bomb','ni_silent_assassin'],gx:2,gz:0},
  {team:'player',kind:'archer', name:'Gunnar',className:'Artilleur',portrait:'/assets/characters/pixel/full/gunnar.png',hp:100,str:15,mag:4,end:11,dex:19,cha:8,mov:2,weapons:[{name:'Arbalète',icon:'⌁',type:'phys',min:2,max:4,power:10,crit:0.08,acc:0.93}],skills:['ar_calibrated_shot','ar_explosive_retreat','ar_incendiary_grenade','ar_artillery_barrage'],gx:2,gz:1},
