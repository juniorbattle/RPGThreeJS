...
export const SKILL_PRESENTATION: Readonly<Record<HeroSkillId, SkillPresentation>> = Object.freeze({
  ...
  p_radiant_judgement: presentation('magic_cast', 'ultimate_judgement_beam', 'ultimateCast', 'impact', true),

  d_cursed_blade: presentation('melee_light', 'status_curse_mark', 'strike', 'impact'),
  ...
  d_devouring_eclipse: presentation('magic_cast', 'ultimate_eclipse_devour', 'ultimateCast', 'impact', true),
  ...
  n_flame_wave: presentation('magic_cast', 'shape_cone_blast', 'areaCast', 'release'),
  ...
  w_miracle: presentation('heal_cast', 'support_revive_pillar', 'ultimateCast', 'release', true),
  ...
  a_zenith_arrow: presentation('ranged_attack', 'ultimate_zenith_arrow_v2', 'ultimateCast', 'impact', true),
  ...
  ro_fault_breaker: presentation('melee_heavy', 'ultimate_fault_breaker_v2', 'ultimateCast', 'impact', true),
...
export const ENEMY_SKILL_PRESENTATION: Readonly<Record<EnemySkillId, SkillPresentation>> = Object.freeze({
  ...
  boss_apocalypse: bossSignature('magic_cast', 'boss_apocalypse_v2', 'areaCast', 'impact'),
