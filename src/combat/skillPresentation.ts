...
export const SKILL_PRESENTATION: Readonly<Record<HeroSkillId, SkillPresentation>> = Object.freeze({
  ...
  l_firmament_lance: presentation('melee_heavy', 'ultimate_firmament_lance', 'ultimateCast', 'impact', true, undefined, { orientation: 'source_to_target', scaleTier: '5ap_ultimate', visualScale: 1.04 }),
...
export const ENEMY_SKILL_PRESENTATION: Readonly<Record<EnemySkillId, SkillPresentation>> = Object.freeze({
  ...
  enemy_dragon_breath: presentation('magic_cast', 'enemy_dragon_breath', 'areaCast', 'release', undefined, undefined, { orientation: 'align_cone', scaleTier: 'boss', visualScale: 1 }),
